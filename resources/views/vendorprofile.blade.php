...
@section('content')
    ...
    <div class="container">
        <div class="text-center pt-3">
            ...
            @if ($editMode)
                <a href="/vendor/editprofpic" class="btn btn-primary" type="submit" onclick="">Edit profile picture</a>
            @endif
            @if ($editprofpic)
            <form action="/vendor/editprofpic" method="POST" class="pt-3 text-center" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    <a onclick="return confirm('Are you sure?')" href="/vendor/removeprofpic" class="btn btn-danger">Remove current</a>
        ...
        <hr class="bg-dark">
        @if(!$editMode)
        <form action="/vendor/profile" method="POST" class="pb-5 pt-3" enctype="multipart/form-data">
        @csrf
        ...
        <form action="/vendor/editprofile" method="POST" class="pb-5 pt-3" enctype="multipart/form-data">
            @csrf
            {{method_field('PUT')}}
            <div class="px-5" style="margin: 0 10%">
