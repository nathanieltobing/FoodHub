                ...
                <div class="col-md-12 col-lg-12 col-xl-12 order-2 order-lg-1">
                  ...
                  <form action="/product/vendor/{{$product->id}}" method="POST" enctype="multipart/form-data" class="mx-1 mx-md-4">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input type="number" id="form3Example3c" name="quantity" class="form-control" value={{$product->stock}}>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input type="text" id="form3Example4c" name="price" class="form-control" value={{$product->price}}>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-user fa-lg me-3 fa-fw" style="margin-bottom: 30px;"></i>
                      <div class="form-outline flex-fill mb-0">                 
                        <textarea rows="3" cols="22" name="desc" placeholder="" class="form-control">{{$product->description}}</textarea>
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type="submit" class="btn btn-primary btn-lg" style="line-height :1.66; font-weight: 400; font-family: Poppins;">Edit Product</button>
                    </div>
